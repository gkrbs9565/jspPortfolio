						...
						<div
							...
							<div class="portfolio-content h-100">
								...
								<div class="portfolio-info">
									<h4>
										<a href="portfolio-details.html" title="More Details"><%=rs.getString("p_productId") %></a>
									</h4>
									<p><%=rs.getString("p_productId") %></p>
									<p><%=rs.getString("p_pname") %></p>
									<p><%=rs.getString("p_unitPrice") %></p>
									<p><%=rs.getString("p_description") %></p>
									<p><%=rs.getString("p_category") %></p>
									<p><%=rs.getString("p_condition") %></p>
									<p><%=rs.getString("p_quantity") %></p>
