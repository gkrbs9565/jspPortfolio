	...
	<main class="main">
			...
			<div class="container position-relative" data-aos="fade-up"
				...
				<div class="row gy-5 justify-content-between">
					<div
						...
						<h2>
							<span>Welcome to </span><span class="accent">Impact</span>
						</h2>
					...
					<div class="col-lg-5 order-1 order-lg-2">
						<img src="../resources/../resources/assets/img/hero-img.svg"
							class="img-fluid" alt="">
					</div>
				</div>
			</div>
			...
			<div class="container">
				...
				<div class="row gy-4">
					<div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
						<h3>Voluptatem dignissimos provident laboris nisi ut aliquip
							ex ea commodo</h3>
						<img src="../resources/../resources/assets/img/about.jpg"
							class="img-fluid rounded-4 mb-4" alt="">
						<p>Ut fugiat ut sunt quia veniam. Voluptate perferendis
						...
						<p>Temporibus nihil enim deserunt sed ea. Provident sit
							expedita aut cupiditate nihil vitae quo officia vel. Blanditiis
							eligendi possimus et in cum. Quidem eos ut sint rem veniam qui.
							Ut ut repellendus nobis tempore doloribus debitis explicabo
							similique sit. Accusantium sed ut omnis beatae neque deleniti
							repellendus.</p>
					</div>
					<div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
						<div class="content ps-0 ps-lg-5">
							...
							<ul>
								<li><i class="bi bi-check-circle-fill"></i> <span>Ullamco
										laboris nisi ut aliquip ex ea commodo consequat.</span></li>
								<li><i class="bi bi-check-circle-fill"></i> <span>Duis
										aute irure dolor in reprehenderit in voluptate velit.</span></li>
								<li><i class="bi bi-check-circle-fill"></i> <span>Ullamco
							...
							<div class="position-relative mt-4">
								<img src="../resources/../resources/assets/img/about-2.jpg"
                  ...
                  "spaceBetween": 120
					...
					<div class="swiper-wrapper align-items-center">
						<div class="swiper-slide">
							<img
								src="../resources/../resources/assets/img/clients/client-1.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img
								src="../resources/../resources/assets/img/clients/client-2.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
						...
						<div class="swiper-slide">
							<img src="../resources/assets/img/clients/client-7.png"
								class="img-fluid" alt="">
						</div>
						<div class="swiper-slide">
							<img src="../resources/assets/img/clients/client-8.png"
								class="img-fluid" alt="">
						</div>
					</div>
				</div>
		...
		<section id="stats" class="stats section">
			...
			<div class="container" data-aos="fade-up" data-aos-delay="100">
				...
				<div class="row gy-4 align-items-center">
					...
					<div class="col-lg-5">
						<img src="../resources/assets/img/stats-img.svg" alt=""
							class="img-fluid">
					</div>
								...
								<div class="stats-item d-flex">
									...
									<div>
										<span data-purecounter-start="0" data-purecounter-end="521"
											data-purecounter-duration="1" class="purecounter"></span>
										<p>
											<strong>Projects</strong> <span>adipisci atque cum
												quia aut</span>
										</p>
									</div>
								</div>
								...
								<div class="stats-item d-flex">
									...
									<div>
										<span data-purecounter-start="0" data-purecounter-end="1453"
											data-purecounter-duration="1" class="purecounter"></span>
										<p>
											<strong>Hours Of Support</strong> <span>aut commodi
												quaerat</span>
										</p>
									</div>
								</div>
								...
								<div class="stats-item d-flex">
									...
									<div>
										<span data-purecounter-start="0" data-purecounter-end="32"
											data-purecounter-duration="1" class="purecounter"></span>
										<p>
											<strong>Hard Workers</strong> <span>rerum asperiores
												dolor</span>
										</p>
									</div>
								</div>
		...
		<section id="call-to-action"
			...
			<div class="container">
				...
				<div class="content row justify-content-center" data-aos="zoom-in"
					data-aos-delay="100">
					<div class="col-xl-10">
                  ...
                  "spaceBetween": 10
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<img
									src="../resources/assets/img/testimonials/testimonials-2.jpg"
									class="testimonial-img" alt="">
								<h3>Sara Wilsson</h3>
								<h4>Designer</h4>
								<div class="stars">
								...
								<p>
									<i class="bi bi-quote quote-icon-left"></i> <span>Export
										tempor illum tamen malis malis eram quae irure esse labore
										quem cillum quid cillum eram malis quorum velit fore eram
										velit sunt aliqua noster fugiat irure amet legam anim culpa.</span> <i
										class="bi bi-quote quote-icon-right"></i>
								</p>
							</div>
						</div>
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<img
									src="../resources/assets/img/testimonials/testimonials-3.jpg"
									class="testimonial-img" alt="">
								<h3>Jena Karlis</h3>
								<h4>Store Owner</h4>
								<div class="stars">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<img
									src="../resources/assets/img/testimonials/testimonials-4.jpg"
									class="testimonial-img" alt="">
								<h3>Matt Brandon</h3>
								<h4>Freelancer</h4>
								<div class="stars">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								<img
									src="../resources/assets/img/testimonials/testimonials-5.jpg"
									class="testimonial-img" alt="">
								<h3>John Larson</h3>
								<h4>Entrepreneur</h4>
								<div class="stars">
						...
						<div
							...
							<div class="portfolio-content h-100">
								<a href="../resources/assets/img/portfolio/app-1.jpg"
									...
									src="../resources/assets/img/product/<%=rs.getString("p_filename")%>"
									class="img-fluid" alt="">
								</a>
								<div class="portfolio-info">
									<h4>
										<a href="portfolio-details.html" title="More Details"><%=rs.getString("p_pname")%></a>
									</h4>
									...
									<br />
									<p>
										<a href="./product.jsp?id=<%=rs.getString("p_productId")%>"
											class="btn btn-secondary">상세 정보 바로가기 &raquo;</a>
										<%
                        				if(edit.equals("update")){
                    					 %>
										<a
											href="./editProduct.jsp?id=<%=rs.getString("p_productId") %>"
										...
										<a
											href="#"
											class="btn btn-danger" onclick="deleteConfirm('<%=rs.getString("p_productId") %>')">삭제 &raquo;</a>
										<%
                        				}
                     					%>
									</p>
					...
					<div class="col-lg-8" data-aos="fade-up" data-aos-delay="200">
						...
						<div class="faq-container">
							<div class="faq-item faq-active">
								<h3>
									<span class="num">1.</span> <span>Non consectetur a erat
										nam at lectus urna duis?</span>
								</h3>
							...
							<div class="faq-item">
								<h3>
									<span class="num">2.</span> <span>Feugiat scelerisque
										varius morbi enim nunc faucibus a pellentesque?</span>
								</h3>
								<div class="faq-content">
							...
							<div class="faq-item">
								<h3>
									<span class="num">3.</span> <span>Dolor sit amet
										consectetur adipiscing elit pellentesque?</span>
								</h3>
								<div class="faq-content">
							...
							<div class="faq-item">
								<h3>
									<span class="num">4.</span> <span>Ac odio tempor orci
										dapibus. Aliquam eleifend mi in nulla?</span>
								</h3>
								<div class="faq-content">
									<p>Dolor sit amet consectetur adipiscing elit pellentesque
										habitant morbi. Id interdum velit laoreet id donec ultrices.
							...
							<div class="faq-item">
								<h3>
									<span class="num">5.</span> <span>Tempus quam
										pellentesque nec nam aliquam sem et tortor consequat?</span>
								</h3>
								<div class="faq-content">
